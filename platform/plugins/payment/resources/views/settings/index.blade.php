            ...
            <div class="group flexbox-annotated-section">
                ...
                <div class="col-md-9">
                    ...
                    <div class="wrapper-content pd-all-20">
                        ...
                        />
                        <button
                            class="btn btn-info button-save-payment-settings"
                            type="button"
                                    ...
                                    <td colspan="3">
                                        ...
                                        >
                                            <div class="payment-name-label-group">
                                                ...
                                                @endif
                                                <label
                                                    class="ws-nm inline-display method-name-label">{{ setting('payment_cod_name', PaymentMethodEnum::COD()->label()) }}</label>
                                            </div>
                                        </div>
                                        <div class="float-end">
                                            <a
                                                class="btn btn-secondary toggle-payment-item edit-payment-item-btn-trigger @if ($codStatus == 0) hidden @endif">{{ trans('plugins/payment::payment.edit') }}</a>
                                            <a
                                                class="btn btn-secondary toggle-payment-item save-payment-item-btn-trigger @if ($codStatus == 1) hidden @endif">{{ trans('plugins/payment::payment.settings') }}</a>
                                        </div>
                                    </td>
                                </tr>
                                            ...
                                            <div class="well bg-white">
                                                ...
                                                <x-core-setting::form-group>
                                                    <label
                                                        ...
                                                        for="payment_cod_description"
                                                    >{{ trans('plugins/payment::payment.payment_method_description') }}</label>
                                    ...
                                    <td colspan="3">
                                        ...
                                        >
                                            <div class="payment-name-label-group">
                                                ...
                                                @endif
                                                <label
                                                    class="ws-nm inline-display method-name-label">{{ setting('payment_bank_transfer_name', PaymentMethodEnum::BANK_TRANSFER()->label()) }}</label>
                                            </div>
                                        </div>
                                        <div class="float-end">
                                            <a
                                                class="btn btn-secondary toggle-payment-item edit-payment-item-btn-trigger @if ($bankTransferStatus == 0) hidden @endif">{{ trans('plugins/payment::payment.edit') }}</a>
                                            <a
                                                class="btn btn-secondary toggle-payment-item save-payment-item-btn-trigger @if ($bankTransferStatus == 1) hidden @endif">{{ trans('plugins/payment::payment.settings') }}</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="payment-content-item hidden">
                                        ...
                                        <div class="col-sm-12 mt-2">
                                            <div class="well bg-white">
                                                ...
                                                <x-core-setting::form-group>
                                                    <label
                                                        class="text-title-field"
                                                        for="payment_bank_transfer_description"
                                                    >{{ trans('plugins/payment::payment.payment_method_description') }}</label>
